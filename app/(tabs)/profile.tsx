      ...
      <ScrollView style={styles.scrollView}>
        {userData ? (
          ...
          <View style={styles.profileContainer}>
            ...
            <ThemedText style={styles.displayName}>{userData.displayName}</ThemedText>
            <ThemedText style={styles.username}>@{userData.username}</ThemedText>
            
            <View style={styles.statsContainer}>
              <View style={styles.statItem}>
                <ThemedText style={styles.statValue}>{userData.exp || 0}</ThemedText>
                <ThemedText style={styles.statLabel}>EXP</ThemedText>
              </View>
              <View style={styles.statItem}>
                <ThemedText style={styles.statValue}>{userData.crystals || 0}</ThemedText>
            ...
            <View style={styles.settingsSection}>
              ...
              >
                ...
                <ThemedText style={[styles.settingLabel, styles.logoutText]}>Log Out</ThemedText>
              </TouchableOpacity>
            </View>
          </View>
        ) : (
